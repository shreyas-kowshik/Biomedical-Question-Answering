...
def get_char_word_loc_mapping(context, context_tokens):
    ...
    """
    # print("Context : {}\nContext Tokens : {}".format(context,context_tokens))
...
def main():
    ...
    train_filename = "BioASQ-train-list-7b-full-annotated.json"
    dev_filename = "BioASQ-test-factoid-7b-2.json"
    ...
    preprocess_and_write(train_data, 'train_list', args.data_dir)
